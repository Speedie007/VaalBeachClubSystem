...
namespace VaalBeachClub.Common.Configuration
{
    public class VaalBeachClubFileProvider : PhysicalFileProvider, IVaalBeachClubFileProvider
    {
        ...
        public VaalBeachClubFileProvider(IHostingEnvironment hostingEnvironment)
