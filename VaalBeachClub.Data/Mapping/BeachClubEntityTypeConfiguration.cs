...
{
    public partial class BeachClubEntityTypeConfiguration<TEntity> : IMappingConfiguration, IBaseEntity, IEntityTypeConfiguration<TEntity> where TEntity : BaseEntity
    {
        #region Utilities
